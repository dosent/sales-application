...
import com.simbirsoft.sales.repository.EmployeeRepository;
import com.simbirsoft.sales.service.dto.EmployeeDTO;
import com.simbirsoft.sales.service.mapper.EmployeeMapper;
...
class EmployeeResourceIT {
    ...
    private static final Stack DEFAULT_STACK = Stack.JAVA;
    private static final Stack UPDATED_STACK = Stack.NET;
    ...
    void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getStack()).isEqualTo(DEFAULT_STACK);
        assertThat(testEmployee.getExternalId()).isEqualTo(DEFAULT_EXTERNAL_ID);
    ...
    void putExistingEmployee() throws Exception {
        ...
        assertThat(testEmployee.getStack()).isEqualTo(UPDATED_STACK);
        assertThat(testEmployee.getExternalId()).isEqualTo(UPDATED_EXTERNAL_ID);
    ...
    void partialUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.location(UPDATED_LOCATION).stack(UPDATED_STACK).salary(UPDATED_SALARY);
