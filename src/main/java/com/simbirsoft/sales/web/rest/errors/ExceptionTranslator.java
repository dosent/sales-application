package com.simbirsoft.sales.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.simbirsoft.sales.service.EmailAlreadyUsedException ||
            ex instanceof com.simbirsoft.sales.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.simbirsoft.sales.service.InvalidPasswordException
