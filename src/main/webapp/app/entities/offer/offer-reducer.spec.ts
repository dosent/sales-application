...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './offer.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OFFER_LIST actions', async () => {
    ...
    it('dispatches FETCH_OFFER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OFFER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OFFER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OFFER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OFFER actions', async () => {
      const expectedActions = [
        {
